...
async def _(event):
    await event.edit(
        "[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - النشـر & السوبـرات 🎡](t.me/ZThon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            [
                Button.inline("النشـر التكـراري 🏟", data="nashzed"),
            ],
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - النشـر & السوبـرات 🎡](t.me/ZThon) .
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
**⎉╎قـائمـة اوامـر النشـر العـام (السـوبـر) الخاص بسـورس زدثـــون ♾ :**
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
`.سوبر`
**⪼ الامـر + عـدد الثـوانـي + عـدد مـرات التكـرار (بالـرد ع رسـالة او ميديـا)**
**⪼ لـ النشـر التكـراري العـام بكـل المجموعـات ( خـاص بجماعـة بالسـوبـرات ) ...✓**
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
`.ايقاف سوبر`
...
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
`.اضف السوبرات`
**⪼ اولاً قم بتجميع ايديـات السـوبرات التي تريـد النشـر فيـها عبـر الامـر التـالي :**
**⪼ ارسـل في كل مجموعـة الامـر** `.الايدي`
**⪼ يجب ان يبـدأ ايـدي كـل سوبـر بــ**
-100
**⪼ قم بتجميـع الايديـات في رسـالة واحـدة بحيث يكون ايدي واحـد في كل سطـر**
**⪼ مثـــال :**
-10046654466
-10046654455
-10046776788
**⪼ بعـد ذلك قـم بالـرد ع الرسـالة بالامــر :**
`.اضف السوبرات`
**⪼ لـ اضافة مجموعـات محـددة لـ قائمـة مجموعـات السوبـر التي تريـد النشـر فيهـا ...✓**
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
`.السوبرات`
...
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
**⪼ مـلاحظــه هـامــه :**
- اوامـر السوبـرات خاصـه وحصريـه بسـورس زدثــون¹ فقـط ...
- سيتم اضـافـه المزيـد من اوامـر السـوبر بالتحديثـات الجايـه ...
- شكـر خـاص لمنصبيـن السـورس علـى افكـارهم الرائعـه والمفيـده ...
""",
        buttons=[
            [Button.inline("رجوع", data="superzzz")],
        ],
...
`.العرب`  /  `.ايقاف العرب`
**⪼ لـ تجميـع النقـاط مـن بـوت ( @xsex21bot ) .. تلقـائيـاً ✓**
...
`.برليون`  /  `.ايقاف برليون`
**⪼ لـ تجميـع النقـاط مـن بـوت ( @Burlliobot ) .. تلقـائيـاً ✓**
...
`.تحويل المليار` / `.تحويل الجوكر` / `.تحويل العقاب` / `.تحويل دعمكم` / `.تحويل العرب` / `.تحويل المليون` / `.تحويل هايبر` / `.تحويل برليون` / `.تحويل تناهيد` / `.تحويل اليمن` / `.تحويل مهدويون`
...
**- ملاحظـه :**
افضل بوت تمويل طاش حاليـاً لتجميع النقاط هو بوت المليـار وبـوت دعمكـم
