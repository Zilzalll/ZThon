...
if Config.ZELZAL_A:
    ...
    async def install():
        ...
        try:
            ...
            documentss = await zedub.get_messages(entity, None, filter=InputMessagesFilterDocument)
        except ValueError:
            documentss = await zedub.get_messages(Config.ZELZAL_A, None, filter=InputMessagesFilterDocument)
